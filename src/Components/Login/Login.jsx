...
const Login = () => {
  ...
  const handleLogin = e => {
    ...
    signIn(email, password)
      .then(result => {
        ...
        axios.post('https://hotel-server-nine.vercel.app/jwt', { email: LoggedInUser.email }, { withCredentials: true })
          .then(res => {
  ...
  return (
    <div className='bg-white font-poppins'>
      ...
      <div className="flex justify-center items-center md:w-3/4 lg:w-1/2 mx-auto">
        <div className="w-1/2">
          <form onSubmit={handleLogin} className="bg-white">
            <div className="form-control">
              ...
              <input type="email" required name="email" className="input input-bordered bg-white border-blue-500 text-black" />
            </div>
            <div className="form-control">
              <label className="label">
              ...
              <div className='relative'>
                <input type={showPassword ? "text" : "password"}
                  ...
                  className="input input-bordered bg-white border-blue-500 text-black pr-10" />
