...
const Register = () => {
    ...
    return (
        <div className='bg-white font-poppins '>
            ...
            <div className="flex justify-center  md:w-3/4 lg:w-1/2 mx-auto">
                <div className="w-1/2">
                    <form onSubmit={handleRegister} className="bg-white">
                        <div className="form-control">
                            ...
                            <input type="text" required name="name" placeholder="Name" className="input input-bordered bg-white border-blue-500 text-black" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text text-black">Email</span>
                            </label>
                            <input type="email" required name="email" placeholder="Email" className="input input-bordered bg-white border-blue-500 text-black" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn text-white bg-blue-500 hover:bg-blue-700">Register</button>
                        </div>
                    </form>
